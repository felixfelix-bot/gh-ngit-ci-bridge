...
```bash
git clone nostr://npub1x677kgulh6lqaa8e658f9ts4s0x692wgrhcptw535877wfkuwnsqztaquc/relay.ngit.dev/gh-ngit-ci-bridge
git clone https://relay.ngit.dev/npub1x677kgulh6lqaa8e658f9ts4s0x692wgrhcptw535877wfkuwnsqztaquc/gh-ngit-ci-bridge.git
git clone https://gitnostr.com/npub1x677kgulh6lqaa8e658f9ts4s0x692wgrhcptw535877wfkuwnsqztaquc/gh-ngit-ci-bridge.git
```

- **Browse / open PRs:** https://gitworkshop.dev/npub1x677kgulh6lqaa8e658f9ts4s0x692wgrhcptw535877wfkuwnsqztaquc/relay.ngit.dev/gh-ngit-ci-bridge
...
- **Announcement (source of truth for the URLs above):** kind `30617`,
  `d=gh-ngit-ci-bridge`, by `36bdeb239fbebe0ef4f9d50e92ae1583cda2a9c81df015ba91a1fde726dc74e0`, relays: `wss://relay.ngit.dev wss://gitnostr.com`
...
```bash
nak req -k 1063 -t "A=30617:36bdeb239fbebe0ef4f9d50e92ae1583cda2a9c81df015ba91a1fde726dc74e0:gh-ngit-ci-bridge" wss://relay.ngit.dev   # url + x tags
```
...
`1e560be4193dd4cc662546a3c8a2184f424dd9b2f6f503fb3f537741b116d053` (created 1789130125). Doc not be hand-edited: re-run the generator.*
